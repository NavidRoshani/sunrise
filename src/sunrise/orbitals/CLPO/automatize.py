...
subprocess.call(['rm','molden2aim.exe'])
subprocess.call(['rm','JANPA.jar'])
subprocess.call(['rm','molden2molden.jar'])
subprocess.call(['rm','nwchem2molden.exe'])
subprocess.call(['rm','replace'])
